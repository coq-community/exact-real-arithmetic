...
apply
 Zabs_ind_ter
  with (P1 := fun zc wc : Reelc => (0 < Zabs (zc (p_max wc n)))%Z).
3: tauto.
intros.
generalize (H H2 H0).
...
apply
 Rlt_2_le_lt_and
  with
    (IZR (1 + Zabs (xc (p_max yc n) * yc (p_max xc n))) *
     / B_powerRZ (p_max yc n + p_max xc n - n) - 1 * / 2)
    (IZR (1 + Zabs (xc (p_max yc n) * yc (p_max xc n))) *
     / B_powerRZ (p_max yc n + p_max xc n - n) + 1 * / 2).
2: apply Rlt_le_2_gauss.
2: generalize
    (gauss_correct_pow (1 + Zabs (xc (p_max yc n) * yc (p_max xc n)))
...
RingReplace (0 + 1) 1; RingReplace 1 (IZR (Zsucc 0)).
apply IZR_le.
...
RingReplace 1%Z (Zsucc 0); apply Zle_succ.
apply Zabs_pos.
...
intro.
apply Rle_trans with (4 * / B_powerRZ (Zsucc (Zsucc 0))).
replace (4 * / B_powerRZ (Zsucc (Zsucc 0))) with
 (4 * INR B * / B_powerRZ (Zsucc (Zsucc (Zsucc 0)))).
apply
 Rle_trans
  with
    (2 * INR B *
...
replace (/ B_powerRZ (Zsucc (Zsucc (Zsucc 0)))) with
 (B_powerRZ (- Zsucc (Zsucc (Zsucc 0)))).
...
RingReplace (2 * B_powerRZ (- Zsucc (Zsucc (Zsucc 0))))
 (B_powerRZ (- Zsucc (Zsucc (Zsucc 0))) +
  B_powerRZ (- Zsucc (Zsucc (Zsucc 0)))).
apply Rplus_le_compat.
...
rewrite Zplus_comm.
apply Zplus_le_reg_r with (Zsucc (Zsucc (Zsucc 0))).
simpl in |- *.
...
rewrite Rmult_assoc; apply Rmult_eq_compat_l.
unfold B_powerRZ in |- *.
replace (powerRZ (INR B) (Zsucc (Zsucc (Zsucc 0)))) with
 (powerRZ (INR B) (Zsucc (Zsucc 0)) * INR B).
replace (/ (powerRZ (INR B) (Zsucc (Zsucc 0)) * INR B)) with
 (/ powerRZ (INR B) (Zsucc (Zsucc 0)) * / INR B).
rewrite Rmult_comm; rewrite Rmult_assoc.
...
fourier.
unfold B_powerRZ in |- *.
replace (powerRZ (INR B) (Zsucc (Zsucc 0))) with (INR B * INR B).
apply Rmult_le_compat.
fourier.
fourier.
replace 4 with (INR 4).
...
apply le_INR; generalize B_sup_4; omega.
do 4 rewrite S_INR; simpl in |- *; ring.
RingReplace (Zsucc (Zsucc 0)) (Zsucc 0 + Zsucc 0)%Z.
replace (powerRZ (INR B) (Zsucc 0 + Zsucc 0)) with
 (powerRZ (INR B) (Zsucc 0) * powerRZ (INR B) (Zsucc 0)).
...
apply
 Rle_trans
  with (1 * / INR B + 2 * INR B * / B_powerRZ (Zsucc (Zsucc (Zsucc 0)))). 
apply
 Rle_trans
  with
    (/ B_powerRZ (p_max yc n + p_max xc n - n) +
...
replace (INR B) with (powerRZ (INR B) (Zsucc 0)).
apply Rle_powerRZ.
...
replace (B_powerRZ n * B_powerRZ (Zsucc (Zsucc (Zsucc 0)))) with
 (B_powerRZ (n + Zsucc (Zsucc (Zsucc 0)))).
unfold B_powerRZ in |- *; apply Rle_powerRZ.
apply Rlt_le; apply Rlt_le_trans with 4.
fourier.
replace 4 with (INR 4).
...
apply Rgt_not_eq; apply Rlt_gt; apply INR_B_non_nul.
unfold B_powerRZ in |- *.
apply Rle_trans with (1 * / 4 + 2 * / powerRZ 4 (Zsucc (Zsucc 0))).
apply Rplus_le_compat.
...
fourier.
replace (/ powerRZ (INR B) (Zsucc (Zsucc (Zsucc 0)))) with
 (powerRZ (INR B) (- Zsucc (Zsucc (Zsucc 0)))).
replace (/ powerRZ 4 (Zsucc (Zsucc 0))) with (powerRZ 4 (- Zsucc (Zsucc 0))).
replace (INR B * powerRZ (INR B) (- Zsucc (Zsucc (Zsucc 0)))) with
 (powerRZ (INR B) (Zsucc 0 + - Zsucc (Zsucc (Zsucc 0)))).
simpl in |- *.
