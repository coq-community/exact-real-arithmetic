...
all: Absolue.vo\
  ...
  Multiplication.vo\
  Oppose.vo\
  powerRZ_complements.vo\
  Rabsolu_complements.vo\
  Racine.vo\
  Rbase_doubles_inegalites.vo\
  Rbase_inegalites.vo\
  Rbase_operations.vo\
  Rind_complements.vo\
  Rlog.vo\
  ...
  Tactiques.vo\
  Zabs_complements.vo\
  Zarith_inegalites.vo\
  Zarith_operations.vo\
  Zdec_complements.vo\
  Zdiv2_complements.vo\
  Zind_complements.vo\
  Zmax.vo\
  Zpower_complements.vo\
  Zsgn_complemnts.vo\
  Zsqrt_complements.vo
